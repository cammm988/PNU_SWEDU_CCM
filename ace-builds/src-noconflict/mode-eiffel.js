...
var EiffelHighlightRules = function() {
    ...
    this.$rules = {
        "start": [{
                token : "string.quoted.test", // Aligned-verbatim-strings (verbatim option not supported)
                regex : /"\[/,
                next: "aligned_verbatim_string"
            }, {
                token : "string.quoted.test", // Non-aligned-verbatim-strings (verbatim option not supported)
                regex : /"\{/,
