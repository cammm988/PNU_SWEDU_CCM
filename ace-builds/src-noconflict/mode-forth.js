    ...
    this.$rules = { start: [ { include: '#forth' } ],
      ...
      '#word':
       [ { token: 'keyword.control.immediate.forth',
           ...
           caseInsensitive: true},
         { token: 'keyword.test.immediate.forth',
         ...
         { token: 'keyword.control.compile-only.forth',
           ...
           caseInsensitive: true},
         { token: 'keyword.test.compile-only.forth',
