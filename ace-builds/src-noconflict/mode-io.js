    ...
    this.$rules = { start: 
       [ { token: 'keyword.control.io',
         ...
         { token: 'variable.language.io',
           ...
           comment: 'I wonder if some of this isn\'t variable.test.language? --Allan; scoping this as variable.language to match Objective-C\'s handling of \'self\', which is inconsistent with C++\'s handling of \'this\' but perhaps intentionally so -- Rob' },
         { token: 'keyword.operator.io',
           regex: '<=|>=|=|:=|\\*|\\||\\|\\||\\+|-|/|&|&&|>|<|\\?|@|@@|\\b(?:and|or)\\b' },
         { token: 'constant.test.io', regex: '\\bGL[\\w_]+\\b' },
         ...
         { token: 'variable.test.global.io', regex: 'Lobby\\b' },
