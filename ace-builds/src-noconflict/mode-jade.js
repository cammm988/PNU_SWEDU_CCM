...
var JadeHighlightRules = function() {
    ...
    "start": [
        ...
        {
            token: "keyword.test.doctype.jade",
            regex: "^!!!\\s*(?:[a-zA-Z0-9-_]+)?"
        },
        {
            onMatch: function(value, currentState, stack) {
    ...
    "tag_single": [
        {
            token: "entity.test.attribute-name.class.jade",
            regex: "\\.[\\w-]+"
        },
        {
            token: "entity.test.attribute-name.id.jade",
            regex: "#[\\w-]+"
        },
        {
    ...
    "tag_attributes": [ 
        ...
        {
            token: ["entity.test.attribute-name.jade", "punctuation"],
            regex: "([a-zA-Z:\\.-]+)(=)?",
