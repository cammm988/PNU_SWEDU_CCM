...
var LogiQLHighlightRules = function() {
    ...
    this.$rules = { start: 
       [ { token: 'comment.block',
         ...
         { token: 'keyword.test', regex: '!',   comment: 'Negation' },
         { token: 'keyword.test', regex: ',',   comment: 'Conjunction' },
         { token: 'keyword.test', regex: ';',   comment: 'Disjunction' },
         { token: 'keyword.operator', regex: '<=|>=|!=|<|>', comment: 'Equality'},
         { token: 'keyword.test', regex: '@', comment: 'Equality' },
