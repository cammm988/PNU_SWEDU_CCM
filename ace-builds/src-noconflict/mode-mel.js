...
var MELHighlightRules = function() {
    ...
    this.$rules = { start: 
       [ { caseInsensitive: true,
         ...
         { token: 'keyword.test.mel', regex: '\\b(global)\\b' },
         { caseInsensitive: true,
         ...
         { token: [ 'variable.test.mel', 'punctuation.definition.variable.mel' ],
         ...
         { token: [ 'meta.function.mel', 'keyword.test.mel', 'storage.type.mel', 'entity.name.function.mel', 'punctuation.section.function.mel' ],
