...
var ObjectiveCHighlightRules = function() {
    ...
    var specialVariables = [{
            regex: "\\b_cmd\\b",
            token: "variable.test.selector.objc"
        }, {
    ...
    "start": [ 
        ...
        }, 
        {
            token: [ "storage.type.objc", "punctuation.definition.storage.type.objc", 
                       "entity.name.type.objc", "text", "entity.test.inherited-class.objc"
                     ],
        ...
        },
        {
            token: [ "storage.type.objc", "entity.name.type.objc", 
                        "entity.test.inherited-class.objc"
                     ],
        ...
        {
            token: ["punctuation.definition.keyword.objc", "keyword.test.objc"],
            regex: "(@)(defs|encode)\\b"
        },
        {
    ...
    "protocol_list": [
        ...
        {
            token: "support.test.protocol.objc",
    ...
    "bracketed_strings": [
        ...
        },
        {
            ...
            token: "keyword.test.modifier.predicate.cocoa"
        },
        {
            regex: "\\b(?:ANYKEY|SUBQUERY|CAST|TRUEPREDICATE|FALSEPREDICATE)\\b",
            token: "keyword.test.predicate.cocoa"
        },
        {
            regex: escapedConstRe,
            token: "constant.character.escape.objc"
