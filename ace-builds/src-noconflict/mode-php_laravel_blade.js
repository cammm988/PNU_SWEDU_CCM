...
var CssHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "ruleset" : [{
            ...
            token : ["punctuation", "entity.test.attribute-name.pseudo-element.css"],
            regex : pseudoElements
        }, {
            token : ["punctuation", "entity.test.attribute-name.pseudo-class.css"],
            regex : pseudoClasses
        }, {
            include: "url"
        }, {
...
function JSX() {
    ...
    {
        token : "entity.test.attribute-name.xml",
        regex : tagRegex
    }, {
...
var XmlHighlightRules = function(normalize) {
    ...
    this.$rules = {
        ...
        processing_instruction : [{
            token : "entity.test.attribute-name.decl-attribute-name.xml",
            regex : tagRegex
        }, {
...
var PHPLaravelBladeHighlightRules = function() {
    ...
    var bladeRules = {
        ...
        variables: [{
            ...
            token: ["keyword.operator.blade", "constant.test.property.blade"],
            regex: "(->)([a-zA-Z_][a-zA-Z0-9_]*)\\b"
        }, {
            token: ["keyword.operator.blade",
...
var functionMap = {
    ...
    "array_intersect": [
        ...
        "Returns the entries of arr1 that have values which are present in all the test arguments"
    ],
    "array_intersect_assoc": [
        "array array_intersect_assoc(array arr1, array arr2 [, array ...])",
        "Returns the entries of arr1 that have values which are present in all the test arguments. Keys are used to do more restrictive check"
    ],
    "array_intersect_key": [
        "array array_intersect_key(array arr1, array arr2 [, array ...])",
        "Returns the entries of arr1 that have keys which are present in all the test arguments. Kind of equivalent to array_diff(array_keys($arr1), array_keys($arr2)[,array_keys(...)]). Equivalent of array_intersect_assoc() but does not do compare of the data."
    ],
    "array_intersect_uassoc": [
        "array array_intersect_uassoc(array arr1, array arr2 [, array ...], callback key_compare_func)",
        "Returns the entries of arr1 that have values which are present in all the test arguments. Keys are used to do more restrictive check and they are compared by using an user-supplied callback."
    ],
    "array_intersect_ukey": [
        "array array_intersect_ukey(array arr1, array arr2 [, array ...], callback key_compare_func)",
        "Returns the entries of arr1 that have keys which are present in all the test arguments. Kind of equivalent to array_diff(array_keys($arr1), array_keys($arr2)[,array_keys(...)]). The comparison of the keys is performed by a user supplied function. Equivalent of array_intersect_uassoc() but does not do compare of the data."
    ],
    "array_key_exists": [
    ...
    "array_uintersect": [
        ...
        "Returns the entries of arr1 that have values which are present in all the test arguments. Data is compared by using an user-supplied callback."
    ],
    "array_uintersect_assoc": [
        "array array_uintersect_assoc(array arr1, array arr2 [, array ...], callback data_compare_func)",
        "Returns the entries of arr1 that have values which are present in all the test arguments. Keys are used to do more restrictive check. Data is compared by using an user-supplied callback."
    ],
    "array_uintersect_uassoc": [
        "array array_uintersect_uassoc(array arr1, array arr2 [, array ...], callback data_compare_func, callback key_compare_func)",
        "Returns the entries of arr1 that have values which are present in all the test arguments. Keys are used to do more restrictive check. Both data and keys are compared by using user-supplied callbacks."
    ],
    "array_unique": [
    ...
    "dba_delete": [
        ...
        "Deletes the entry associated with key    If inifile: remove all test key lines"
    ],
    "dba_exists": [
    ...
    "dba_replace": [
        ...
        "Inserts value as key, replaces key, if key exists already    If inifile: remove all test key lines"
    ],
    "dba_sync": [
    ...
    "dom_node_compare_document_position": [
        "short dom_node_compare_document_position(DomNode test);",
    ...
    "dom_node_is_same_node": [
        "boolean dom_node_is_same_node(DomNode test);",
    ...
    "ibase_blob_info": [
        ...
        "Return blob length and test useful info"
    ],
    "ibase_blob_open": [
    ...
    "localtime": [
        ...
        "Returns the results of the C system call localtime as an associative array if the associative_array argument is set to 1 test wise it is a regular array"
    ],
    "log": [
    ...
    "mysql_get_client_info": [
        ...
        "Returns a string that represents the client lib version"
    ],
    "mysql_get_host_info": [
    ...
    "odbc_foreignkeys": [
        ...
        "Returns a result identifier to either a list of foreign keys in the specified table or a list of foreign keys in test tables that refer to the primary key in the specified table"
    ],
    "odbc_free_result": [
    ...
    "sqlite_libencoding": [
        ...
        "Returns the encoding (iso8859 or UTF-8) of the linked SQLite lib."
    ],
    "sqlite_libversion": [
        "string sqlite_libversion()",
        "Returns the version of the linked SQLite lib."
    ],
    "sqlite_next": [
    ...
    "tidy_get_release": [
        ...
        "Get release date (version) for Tidy lib"
    ],
    "tidy_get_root": [
