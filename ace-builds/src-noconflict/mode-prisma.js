ace.define("ace/mode/prisma_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var PrismaHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "#assignment": [{
            token: [
                "text",
                "variable.test.assignment.prisma",
                "text",
