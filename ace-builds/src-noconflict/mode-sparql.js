...
var SPARQLHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "#qnames": [{
            token: "entity.name.test.qname.sparql",
        ...
        "#relative-urls": [{
            token: "string.quoted.test.relative.url.sparql",
            regex: /</,
            push: [{
                token: "string.quoted.test.relative.url.sparql",
                regex: />/,
                ...
                defaultToken: "string.quoted.test.relative.url.sparql"
            }]
        }],
