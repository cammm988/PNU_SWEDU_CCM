...
var TurtleHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "#base-prefix-declarations": [{
            token: "keyword.test.prefix.turtle",
            regex: /@(?:base|prefix)/
        }],
        "#comments": [{
            token: [
        ...
        "#qnames": [{
            token: "entity.name.test.qname.turtle",
        ...
        "#relative-urls": [{
            token: "string.quoted.test.relative.url.turtle",
            regex: /</,
            push: [{
                token: "string.quoted.test.relative.url.turtle",
                regex: />/,
                ...
                defaultToken: "string.quoted.test.relative.url.turtle"
            }]
        }],
