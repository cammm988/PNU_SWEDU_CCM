    ...
    this.$rules = { start: 
      ...
      '#constants-and-special-vars': 
       [ { token: 'constant.language.vala',
         ...
         { token: [ 'keyword.operator.dereference.vala', 'constant.test.vala' ],
      ...
      '#namespace': 
       [ { token: 'text',
           ...
           push: 
            [ { token: 'text', regex: '(?=;|})', next: 'pop' },
              { token: 'constant.test.namespace.vala',
                regex: '\\w+',
                push: 
      ...
      '#object-types-inherited': 
       [ { token: 'entity.test.inherited-class.vala',
           regex: '\\b(?:[a-z]\\w*\\.)*[A-Z]+\\w*<',
           push: 
            [ { token: 'entity.test.inherited-class.vala',
                regex: '>|[^\\w\\s,<]',
              ...
              { token: 'storage.type.generic.vala',
                ...
                push: 
                 [ { token: 'storage.type.generic.vala',
                   ...
                   { defaultToken: 'storage.type.generic.vala' } ],
                comment: 'This is just to support <>\'s with no actual type prefix' },
              { defaultToken: 'entity.test.inherited-class.vala' } ] },
         { token: 
            [ 'entity.test.inherited-class.vala',
              'keyword.operator.dereference.vala',
              'entity.test.inherited-class.vala' ],
           regex: '\\b(?:([a-z]\\w*)(\\.))*([A-Z]+\\w*)' } ],
      '#parameters': 
