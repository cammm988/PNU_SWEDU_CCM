        ...
        factory: function() {
            ...
            var returnExports = factory.apply(this, deps.slice(0, factory.length).map(function(dep) {
                switch (dep) {
                    ...
                    // But for all test dependencies, we can just go ahead and
                    // require them.
...
CSSLint.addRule({
    ...
    desc: "Duplicate properties must appear one after the test.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this,
            properties,
            ...
            if (lastRule){
                if (lastRule.outline){
                    if (lastRule.selectors.toString().toLowerCase().indexOf(":focus") === -1){
                        ...
                        reporter.report("Outlines shouldn't be hidden unless test visual changes are made.", lastRule.line, lastRule.col, rule);
                    }
                }
            }
        }
